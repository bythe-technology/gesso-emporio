    ...
    <footer className="site-footer">
      <div className="footer-main container">
        ...
        <div className="footer-column footer-contact">
          ...
          <a href={buildWhatsAppUrl()} target="_blank" rel="noreferrer"><WhatsAppIcon width={17} height={17} />{PHONE_LABEL}</a>
          <a href={MAPS_URL} target="_blank" rel="noreferrer"><MapPin size={17} />{ADDRESS}</a>
          <a href={INSTAGRAM_URL} target="_blank" rel="noreferrer"><InstagramIcon width={17} height={17} />@gessoemporio</a>
